    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-[70px] items-center'>
        ...
        className='flex flex-col lg:flex-row flex-1'>
          <div className='text-[306px] xl:text-[720px]
        leading-none font-tertiary lg:-tracking-[0.07em] bg-about bg-no-repeat
        bg-right bg-clip-text text-transparent'>01</div>
        </motion.div>
        ...
        className='flex-1 h-full xl:mt-48'>
          ...
          <div className='flex flex-col items-end'>
            ...
            <button className='btn btn-lg btn-link'>{btnText}
